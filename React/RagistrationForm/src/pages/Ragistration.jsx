...
const Ragistration = () => {
  return (
    <>
      <div>
        <div>
          <div className="border border-e-black rounded shadow mx-3 pt-5 mt-3 pb-2 ">
        ...
        <div className="border border-e-black rounded shadow p-3 pt-5 mx-3 mt-3">
        ...
        {/* course Information */}
        <div className="border border-e-black rounded shadow p-3 mx-3 pt-5 mt-3">
